                      ...
                      {sizesArr.map(s => (
                        <button 
                          ...
                          style={{ 
                            ...
                            border: `2px solid ${selectedSize === s ? "var(--color-text-primary)" : "var(--color-border)"}`,
                            backgroundColor: selectedSize === s ? "var(--color-text-primary)" : "transparent",
                            color: selectedSize === s ? "var(--color-bg-primary)" : "var(--color-text-primary)",
                            borderRadius: "8px",
                            fontWeight: 600,
                            cursor: "pointer",
                    ...
                    <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                      {colorsArr.map(c => (
                        <button 
                          ...
                          style={{ 
                            padding: "10px 20px", 
                            border: `2px solid ${selectedColor === c ? "var(--color-text-primary)" : "var(--color-border)"}`,
                            backgroundColor: selectedColor === c ? "var(--color-text-primary)" : "transparent",
                            color: selectedColor === c ? "var(--color-bg-primary)" : "var(--color-text-primary)",
                            borderRadius: "30px",
                            fontWeight: 600,
                            fontSize: "0.9rem",
                            cursor: "pointer",
