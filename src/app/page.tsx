...
export default function Home() {
  return (
    <div style={{ width: "100%" }}>
      ...
      {/* Reservaciones Section — contenido pegado a 15px a la izquierda, foto a la derecha a futuro */}
      ...
      {/* Talleres Section */}
      <FadeIn delay={300} direction="up" style={{ width: "100%", maxWidth: "1100px", padding: "0 24px", margin: "0 auto" }}>
